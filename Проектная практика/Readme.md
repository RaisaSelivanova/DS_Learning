...
Forest-Fire-Detection  -  это дообученная модель компьютерного зрения на основе архитектуры SigLIP, которая анализирует изображения для классификации сцен на три категории:
...
##### Практическая ценность модели:
 ...
 - раннее обнаружение признаков пожара/задымления, что позволит оперативно произвести тушение, предотвратив распространение возгорания на большую площадь территории
 ...
 - аналитическая ценность: анализ архивных и текущих визуальных данных позволит оценить пожароопасность на исследуемых территориях
...
### 1.Подготовка
- загрузка модели
- подготовка тестового набора данных: использовано 21 изображение - по 7 фото каждого класса (fire, smoke, normal)
ссылка на датасет: ...
